  ...
  if (login_check_user()) {
    ...
    ?>
      ...
      <div class="widget widget_shopping_cart">
        ...
        <div>
          <ul style="margin-bottom:10px;margin-left:22px">
            <li>
  ...
  <?php
    ...
    ?>
      ...
      <div class="widget widget_shopping_cart">
        ...
        <div>
          <form method="post" action="<?php print URL; ?>login.php">    
          ...
          <table style="width:100%;">
            ...
            <tr>
              ...
              <td><input type="text" class="input_text" name="username" style="width:120px"></td>
            </tr>
            <tr>
              <td><?php print _t('Password') ?></td>
              <td><input type="password" class="input_text" name="password" style="width:120px"></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
